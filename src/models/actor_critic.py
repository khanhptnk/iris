...
from models.nets import LSTMActorCriticNet
...
class ActorCritic(nn.Module):
    def __init__(self, act_vocab_size: int, cfg: DictConfig) -> None:
        super().__init__()

        self.use_original_obs = cfg.use_original_obs
        ...
        self.net = LSTMActorCriticNet(act_vocab_size, **cfg.net)
        self.input_shape = tuple(cfg.net.input_shape)
    ...
    def forward(
        ...
        logits_actions, means_values = self.net(inputs, mask_padding=mask_padding)
    ...
    def imagine(
        ...
        assert (
            ...
            and initial_observations.shape[2:] == self.input_shape
        )
